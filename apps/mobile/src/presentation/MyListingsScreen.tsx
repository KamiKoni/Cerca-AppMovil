      ...
      <View style={styles.headerRow}>
        ...
        <View style={styles.headerActions}>
          <Pressable
            ...
            accessibilityRole="button"
          >
            <Text style={styles.secondaryButtonText}>{t('favorites.title')}</Text>
          </Pressable>
          <Pressable
            ...
            accessibilityRole="button"
          >
            <Text style={styles.newButtonText}>+ {t('provider.newListing')}</Text>
          </Pressable>
        </View>
      </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardActions}>
              {item.status === 'published' ? (
                ...
                >
                  <Text style={styles.actionText}>{t('provider.publishListing')}</Text>
                </Pressable>
              )}
              ...
              >
                <Text style={styles.actionText}>{t('provider.viewDetails')}</Text>
              </Pressable>
            </View>
          </View>
        )}
